...
package flaras.view.scene
{
	...
	public class ViewCircularAnimationScene extends ViewAnimationScene
	{
		...
		private var _animationScene:CircularAnimationScene;
		...
		public function ViewCircularAnimationScene(animationScene:CircularAnimationScene, viewFlarasScene:ViewFlarasScene)
		{
			super(viewFlarasScene);
